...
def test_registry_wraps_handler_localization_with_ui_text_bridge(monkeypatch) -> None:
    ...
    def _fake_prompt_editor(
        *,
        ...
        call_order.append("prompt_editor")
    ...
    assert call_order == ["common", "prompt_editor", "presets", "download"]


def test_registry_loads_default_builtin_plugins_when_packages_empty(monkeypatch) -> None:
    call_order: list[str] = []
